...
public actor OSLogDriver: OSLogDriverProtocol {
    private static let _logger = Logger(subsystem: Bundle.main.bundleIdentifier!, category: Constants.Logger.categoryName)
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier!, category: Constants.Logger.categoryName)
