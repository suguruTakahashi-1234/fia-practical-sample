...
public final class SettingPresenterDependencyMock: SettingPresenterDependency {
    public init() { }
    public init(logDriver: LogDriverProtocolAT, buildEnvDriver: BuildEnvDriverProtocolAT) {
        self._logDriver = logDriver
        self._buildEnvDriver = buildEnvDriver
    }
...
public final class BuildEnvDriverProviderMock: BuildEnvDriverProvider {
    public init() { }
    public init(buildEnvDriver: BuildEnvDriverProtocolAT) {
        self._buildEnvDriver = buildEnvDriver
    }
