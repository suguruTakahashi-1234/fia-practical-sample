...
# Presentation 層のコード生成 ex) make presentation-code-gen DI_CONTAINER=AppRoot VIEW=Hoge
...
# UseCase のコード生成 ex) make use-case-code-gen DI_CONTAINER=AppRoot USECASE=Hoge
